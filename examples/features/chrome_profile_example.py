...
async def main():
	...
	agent = Agent(task='Check my Gmail inbox', browser_session=browser_session)
	...
	browser_session_cdp = BrowserSession(cdp_url='http://localhost:9222')

	agent_cdp = Agent(task='Navigate to GitHub and show my profile', browser_session=browser_session_cdp)
