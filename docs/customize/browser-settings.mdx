...
Browser Use uses playwright to manage the browser.

```python
from browser_use import BrowserProfile, BrowserSession
````

- `BrowserSession(**params)` is a connection to a running browser, it takes standard playwright kwargs in and connects to / launches a browser
- `BrowserProfile(**params)` is a collection of static config kwargs that can be passed to playwright to set up a browser
...
browser_session = BrowserSession(
    ...
    # browser_pid=12445,
    # page=playwright_page | browser_context | browser,
