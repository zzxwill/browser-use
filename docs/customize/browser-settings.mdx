...
- **wss_url** (default: `None`)
  WebSocket URL for connecting to external browser providers (e.g., [anchorbrowser.io](https://anchorbrowser.io), [steel.dev](https://steel.dev), [browserbase.com](https://browserbase.com), [browserless.io](https://browserless.io)).
