...
The LLM gets the entire pydantic JSON schema for your params, so it will see the action name & description + individual field names, types, descriptions, and default values.
