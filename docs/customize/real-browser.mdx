...
description: "With this you can connect to an existing running browser or launch a new local browser"
icon: "computer"
---

## Overview

As of Chrome v133, connecting a debugger is no longer supported with your default browser profile.  
Browser-Use has transitioned to creating a new dedicated profile for agents in `~/.config/browseruse/profiles/default`.  
You can set up this profile by logging into everything you need your agent to have access to, and it will persist over time.
