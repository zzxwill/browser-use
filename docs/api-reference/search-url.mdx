...
The Search URL endpoint extracts relevant content from a specific website URL based on your query. This is ideal for targeted content extraction, research on specific websites, or analyzing particular web pages.
...
<ParamField body="depth" type="integer" default="2">
  How deep to navigate within the website (2-5)
</ParamField>
...
- **Content Research**: Extract specific information from research papers, blogs, or news articles
- **Price Monitoring**: Get pricing information from e-commerce sites
- **Data Extraction**: Pull structured data from specific web pages
- **Content Analysis**: Analyze and summarize content from target websites
