	...
	def _build_input_tokens_display(self, usage: ChatInvokeUsage, cost: TokenCostCalculated | None) -> str:
		...
		if cost:
			...
			if new_tokens > 0:
				...
				if self.include_cost and cost.new_prompt_cost > 0:
			...
			if usage.prompt_cached_tokens:
				...
				if self.include_cost and cost.prompt_read_cached_cost:
			...
			if usage.prompt_cache_creation_tokens:
				...
				if self.include_cost and cost.prompt_cache_creation_cost:
