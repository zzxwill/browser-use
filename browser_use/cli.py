...
def get_llm(config: dict[str, Any]):
    ...
    if os.getenv("OPENAI_API_KEY"):
        ...
        print("⚠️  No API keys found. Please update your config or set one of: OPENAI_API_KEY, ANTHROPIC_API_KEY, or GOOGLE_API_KEY.")
        sys.exit(1)
            ...
            try:
                ...
                if connected and hasattr(self, "agent") and self.agent:
                    ...
                    if browser_session.agent_current_page:
                        current_url = (
                            browser_session.agent_current_page.url.replace("https://", "").replace("http://", "").replace("www.", "")[:36] + "…"
                        )
        ...
        with Container(id="main-container"):
            ...
            with Container(id="links-panel"):
                ...
                with HorizontalGroup(classes="link-row"):
                    ...
                    yield Link("https://discord.gg/ESAUZAdxXY", url="https://discord.gg/ESAUZAdxXY", classes="link-purple link-url")
